...
const vendorFiles = ["node_modules/traceur/bin/traceur-runtime.js"];
...
gulp.task("html", () => gulp.src(htmlFiles).pipe(gulp.dest(dist)));
...
gulp.task("images", () => gulp.src(imageFiles).pipe(gulp.dest(dist)));
